                                ...
                                <form action="" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <input type="text" class="form-control" name="name_slider" placeholder="Nhập Tên Slider"
                                                   value="<?= $name_slider; ?>" required="">
                                    ...
                                    <?php if ($update_slider == true) { ?>
                                        <input type="submit" name="updateSlider" class="btn btn-success btn-block"
                                               value="Update Slider">
                                    <?php } else { ?>
                                        <input type="submit" name="insertSlider" class="btn btn-primary btn-block"
                                               value="Add Slider">
                                    <?php } ?>
                                </form>
                                        ...
                                        <table class="table table-striped" id="showAllUser">
                                            ...
                                            <?php while ($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../config/action.php?deleteSlider=<?= $row['id_slider']; ?>"
                                                           class="badge badge-danger p-2"
                                                           onclick="return confirm('Do you want delete this record?');">Xóa</a>
                                                        <a href="slide.php?editSlider=<?= $row['id_slider']; ?>"
