                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            $query = "SELECT * FROM comments where id_product=$id_product";
                            ...
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-header card-header-border-bottom">
                                        <a class="btn btn-danger" href="commentManager.php" style="color: white">Quay Lại</a>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="" method="post">
                                                            ...
                                                            <button name="editComment" class="badge badge-success p-2">Sửa</button>
