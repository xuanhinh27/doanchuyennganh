            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                                ...
                                <form action="" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            <label for="validationServer01">Bình Luận</label>
                        ...
                        <div class="row">
                            <?php $query = "SELECT id_product,id_comment,count(id_product) as alo FROM comments group by id_product";
                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped" id="showAllUser">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col">Mục Sản Phẩm Comment</th>
                                            ...
                                            <?php while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <?php while ($rowComment2 = $resultComment2->fetch_assoc()) { ?>
                                                        <td><?php echo $rowComment2['id_product'] ?></td>
                                                        <td><?php echo $rowComment2['name_product'] ?></td>
                                                    <?php } ?>
                                                    <td>
                                                        <form action="" method="post">
                                                            <input name="id_comment" value="<?= $row['id_comment'] ?>" hidden>
                                                            <button name="deleteComment" class="badge badge-danger p-2" onclick="return confirm('Do you want delete this record?'); ">Xóa</button>
                                                            <a href="detailComment.php?detailComment=<?= $row['id_product']; ?>"
