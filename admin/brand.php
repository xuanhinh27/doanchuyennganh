                                ...
                                <form action="" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            <label for="validationServer01">Tên Hãng</label>
                                            <input type="text" class="form-control" name="name_brand" placeholder="Nhập Tên Hãng"
                                                   value="<?= $name_brand; ?>" required="">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="file" name="image_brand" class="custom-file">
                                            <div class="invalid-feedback">
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <input type="hidden" name="oldBrand" value="<?= $image_brand; ?>">
                                            <img src="<?= $image_brand; ?>" width="120" class="img-thumbnail">
                                    ...
                                    <?php } else { ?>
                                        <input type="submit" name="insertBrand" class="btn btn-primary btn-block"
                                               value="Thêm Hãng">
                                    <?php } ?>
                                </form>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped" id="showAllUser">
                                            ...
                                            <?php while ($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <tr>
                                                    <td scope="row"><img width="100" src="<?php echo $row['image_brand'] ?>">
                                                    </td>
                                                    <td><?php echo $row['name_brand'] ?></td>

                                                    <td>
                                                        <a href="../config/action.php?deleteBrand=<?= $row['id_brand']; ?>"
                                                           class="badge badge-danger p-2"
                                                           onclick="return confirm('Do you want delete this record?');">Xóa</a>
                                                        <a href="brand.php?editBrand=<?= $row['id_brand']; ?>"
