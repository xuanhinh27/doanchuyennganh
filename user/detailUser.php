                        ...
                        <div class="col-lg-8 col-xl-9">
                            <div class="profile-content-right py-5">
                                <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="timeline-tab" data-toggle="tab" href="#time_line" role="tab" aria-controls="timeline" aria-selected="true">Timeline</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content px-3 px-xl-5" id="time_line">
                                        ...
                                        $queryComment = "SELECT * FROM comments inner join users on comments.id_user = users.id_user where comments.id_user=$id_user";
                                        ...
                                        <div class="media mt-5 profile-timeline-media">
                                            <div class="align-self-start iconbox-45 overflow-hidden mr-3">
                                                <img src="<?= $rowComment['avatar']; ?>" alt="Generic placeholder image">
                                            </div>
